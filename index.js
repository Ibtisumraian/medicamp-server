...
app.get('/', (req, res) => {
  ...
  <head>
    ...
    <style>
      ...
      .method-patch { background-color: var(--patch-color); }
  ...
  <body>
    <div class="container">
      ...
      <p>Base URL: <code>https://medicamp-server-three.vercel.app</code></p>
        ...
        <table class="api-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Generates a JSON Web Token for authentication.</td>
            </tr>
            <!-- Camps -->
            <tr>
              <td><span class="method method-post">POST</span></td>
              <td><code>/camps</code></td>
              <td class="auth-no">No</td>
              <td>Adds a new camp.</td>
            </tr>
            <tr>
              <td><span class="method method-get">GET</span></td>
              <td><code>/camps</code></td>
              <td class="auth-no">No</td>
              <td>Retrieves all available camps.</td>
            </tr>
            <tr>
              <td><span class="method method-get">GET</span></td>
              <td><code>/camps/:id</code></td>
              <td class="auth-required">Yes</td>
              <td>Retrieves a single camp by its ID.</td>
            </tr>
            <tr>
              <td><span class="method method-get">GET</span></td>
              <td><code>/TopCamps</code></td>
              <td class="auth-no">No</td>
              <td>Retrieves the top 6 most popular camps.</td>
            </tr>
            <tr>
              <td><span class="method method-put">PUT</span></td>
              <td><code>/update-camp/:id</code></td>
              <td class="auth-required">Yes</td>
              <td>Updates a camp's details.</td>
            </tr>
            <tr>
              <td><span class="method method-patch">PATCH</span></td>
              <td><code>/camps/participantCount/:id</code></td>
              <td class="auth-required">Yes</td>
              <td>Increments a camp's participant count.</td>
            </tr>
            <tr>
              <td><span class="method method-delete">DELETE</span></td>
              <td><code>/delete-camp/:id</code></td>
              <td class="auth-required">Yes</td>
              <td>Deletes a camp.</td>
            </tr>
            <!-- Users -->
            <tr>
              <td><span class="method method-post">POST</span></td>
            ...
            <tr>
              ...
              <td class="auth-required">Yes</td>
              <td>Retrieves a user by email.</td>
            </tr>
            <!-- Participants -->
            <tr>
              <td><span class="method method-post">POST</span></td>
              ...
              <td class="auth-required">Yes</td>
              <td>Registers a participant for a camp.</td>
            </tr>
            <tr>
              <td><span class="method method-get">GET</span></td>
              <td><code>/participants</code></td>
              <td class="auth-required">Yes</td>
              <td>Retrieves all registered participants.</td>
            </tr>
            <tr>
              <td><span class="method method-get">GET</span></td>
              <td><code>/participants/email/:email</code></td>
              <td class="auth-required">Yes</td>
              <td>Retrieves participants by email.</td>
            </tr>
             <tr>
              <td><span class="method method-delete">DELETE</span></td>
              <td><code>/participants/delete/:id</code></td>
              <td class="auth-required">Yes</td>
              <td>Cancels a participant's registration.</td>
            </tr>
            <tr>
              <td><span class="method method-patch">PATCH</span></td>
              <td><code>/participants/payment/:id</code></td>
              <td class="auth-required">Yes</td>
              <td>Confirms a participant's payment.</td>
            </tr>
            <!-- Feedback -->
            <tr>
              <td><span class="method method-post">POST</span></td>
              ...
              <td class="auth-required">Yes</td>
              <td>Submits feedback for a camp.</td>
            </tr>
            <tr>
              <td><span class="method method-get">GET</span></td>
              <td><code>/feedbacks</code></td>
              <td class="auth-no">No</td>
              <td>Retrieves all feedback.</td>
            </tr>
            <!-- Payment -->
            <tr>
              <td><span class="method method-post">POST</span></td>
              <td><code>/create-payment-intent</code></td>
              <td class="auth-no">No</td>
              <td>Creates a Stripe payment intent.</td>
            </tr>
          </tbody>
        </table>
      </div>
